...
e.minToday=function(){var g=new Date(Date.now()-11*60*60*1000);
...
},changeInput:function(g){this.$input=g
...
}},fitVerticalPositionAbsolute:function(){var g=this.$input.offset();
